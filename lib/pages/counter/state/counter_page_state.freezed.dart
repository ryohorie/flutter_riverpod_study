...
class _$CounterPageStateTearOff {
  ...
  _CounterPageState call({int count = 0}) {
...
class _$_CounterPageState extends _CounterPageState
    with DiagnosticableTreeMixin {
  const _$_CounterPageState({this.count = 0}) : super._();
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'CounterPageState(count: $count)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'CounterPageState'))
...
abstract class _CounterPageState extends CounterPageState {
  const factory _CounterPageState({int count}) = _$_CounterPageState;
  const _CounterPageState._() : super._();
